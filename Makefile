all: build/glib_hash_table build/stl_unordered_map build/boost_unordered_map build/google_sparse_hash_map build/google_dense_hash_map build/qt_qhash build/python_dict build/ruby_hash build/perl5_hash
...
build/perl5_hash: src/perl5_hash.c Makefile src/template.c
	gcc -O2 -lm -I/usr/lib/perl5/5.10.1/i386-linux-thread-multi/CORE/ -lperl src/perl5_hash.c -o build/perl5_hash
